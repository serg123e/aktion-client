...
module AktionClient
  class TicketField
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'htmlType')
        self.html_type = attributes[:'htmlType']
      end
    ...
    def hash
      [id, parent_id, name, type_id, type_name, html_type, is_required, sort, children].hash
    end
