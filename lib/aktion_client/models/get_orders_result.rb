...
module AktionClient
  class GetOrdersResult
    ...
    attr_accessor :order_sum

    attr_accessor :order_nr

    attr_accessor :order_name

    attr_accessor :print_bill_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'orderSum')
        self.order_sum = attributes[:'orderSum']
      end

      if attributes.has_key?(:'orderNr')
        self.order_nr = attributes[:'orderNr']
      end
      ...
      if attributes.has_key?(:'printBillId')
        self.print_bill_id = attributes[:'printBillId']
      end
    end
    ...
    def hash
      [customer_name, customer_id, inn, kpp, order_id, author, order_date, document_date, order_sum, order_nr, order_name, print_bill_id].hash
    end
