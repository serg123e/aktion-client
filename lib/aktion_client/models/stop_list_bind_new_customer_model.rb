...
module AktionClient
  class StopListBindNewCustomerModel
    ...
    def list_invalid_properties
      ...
      if @tax_id_number.nil?
        invalid_properties.push('invalid value for "tax_id_number", tax_id_number cannot be nil.')
      end

      if @registration_code.nil?
        invalid_properties.push('invalid value for "registration_code", registration_code cannot be nil.')
      end
    ...
    def hash
      [partner_id, name, tax_id_number, registration_code, phone, parent_id, contact].hash
    end
