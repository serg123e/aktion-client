...
module AktionClient
  class OnlineChat
    ...
    # Оценка чата Клиентом: -1 нет оценки, 0 плохая оценка, 1 - хорошая
    attr_accessor :evaluation

    # Тип чата
    attr_accessor :chat_type

    # Статус чата(активный/закрытый)
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'chatType')
        self.chat_type = attributes[:'chatType']
      end
    ...
    def hash
      [created, evaluation, chat_type, status, bitrix_id].hash
    end
