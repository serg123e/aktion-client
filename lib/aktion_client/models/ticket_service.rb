...
module AktionClient
  class TicketService
    ...
    def self.swagger_types
      {
        ...
        :'default_source' => :'TicketSource',
        :'default_state' => :'TicketState',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'defaultQueue')
        self.default_queue = attributes[:'defaultQueue']
      end

      if attributes.has_key?(:'defaultSource')
        self.default_source = attributes[:'defaultSource']
      end

      if attributes.has_key?(:'defaultState')
        self.default_state = attributes[:'defaultState']
      end
    ...
    def hash
      [default_queue, default_source, default_state, default_account_id, id, name, state_code, status_code].hash
    end
