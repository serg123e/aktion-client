...
module AktionClient
  class CustomerSimple
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'organizationType')
        self.organization_type = attributes[:'organizationType']
      end
    ...
    def hash
      [id, name, tax_id_number, registration_code, sale_forecast, revenue, industry, region, organization_type, assigned, last_contact_date].hash
    end
