...
module AktionClient
  class Account
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'phoneDbFormat')
        self.phone_db_format = attributes[:'phoneDbFormat']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          email == o.email &&
          phone == o.phone &&
          phone_db_format == o.phone_db_format &&
          phones == o.phones &&
    ...
    def hash
      [tax_id_number, pin, city, parent_id, email, phone, phone_db_format, phones, legal_form, registration_code, contacts, created_by, created_on, modified_by, modified_on, id, name, state_code, status_code].hash
    end
