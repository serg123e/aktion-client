...
module AktionClient
  class OperatorStatPhoneCalls
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'endCount')
        self.end_count = attributes[:'endCount']
      end
      ...
      if attributes.has_key?(:'refusalCount')
        self.refusal_count = attributes[:'refusalCount']
      end
    end
    ...
    def hash
      [last_update_date, total_count, end_count, transfer_count, refusal_count].hash
    end
