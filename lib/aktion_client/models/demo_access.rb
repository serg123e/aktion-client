...
module AktionClient
  class DemoAccess
    ...
    def hash
      [authorize_code, main_product, from, to, contact, customer_id, phone_call_id, is_premium, successfully, created_by, created_on, modified_by, modified_on, id, name, state_code, status_code].hash
    end
