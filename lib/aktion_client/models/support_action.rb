...
module AktionClient
  class SupportAction
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'resultDate')
        self.result_date = attributes[:'resultDate']
      end

      if attributes.has_key?(:'resultId')
        self.result_id = attributes[:'resultId']
      end

      if attributes.has_key?(:'resultName')
        self.result_name = attributes[:'resultName']
      end

      if attributes.has_key?(:'resultComment')
        self.result_comment = attributes[:'resultComment']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          result_name == o.result_name &&
          result_comment == o.result_comment &&
    ...
    def hash
      [license_id, result_date, result_id, result_name, result_comment, successfully, user, name, id].hash
    end
