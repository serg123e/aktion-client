...
module AktionClient
  class Preview
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'linkToGo')
        self.link_to_go = attributes[:'linkToGo']
      end
    ...
    def hash
      [name, description, link_to_go, short_description].hash
    end
