...
module AktionClient
  class Region
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'modifiedByName')
        self.modified_by_name = attributes[:'modifiedByName']
      end
    ...
    def hash
      [codes, country, country_name, country_id, name, created_by, created_by_name, modified_by, modified_by_name, created_on, modified_on, state_code, status_code, id].hash
    end
