...
module AktionClient
  class GetInvoicesResult
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'invoiceSum')
        self.invoice_sum = attributes[:'invoiceSum']
      end

      if attributes.has_key?(:'invoiceNr')
        self.invoice_nr = attributes[:'invoiceNr']
      end

      if attributes.has_key?(:'sendingNr')
        self.sending_nr = attributes[:'sendingNr']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          invoice_nr == o.invoice_nr &&
          sending_nr == o.sending_nr &&
    ...
    def hash
      [customer_name, customer_id, inn, kpp, invoice_id, author, invoice_date, invoice_sum, invoice_nr, sending_nr, send_date].hash
    end
