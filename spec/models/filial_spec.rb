...
# Unit tests for AktionClient::Filial
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Filial' do
  before do
    # run before each test
    @instance = AktionClient::Filial.new
  end
  ...
  describe 'test an instance of Filial' do
    it 'should create an instance of Filial' do
      expect(@instance).to be_instance_of(AktionClient::Filial)
    end
  end
