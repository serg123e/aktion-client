...
# Unit tests for AktionClient::PartnerUser
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PartnerUser' do
  before do
    # run before each test
    @instance = AktionClient::PartnerUser.new
  end
  ...
  describe 'test an instance of PartnerUser' do
    it 'should create an instance of PartnerUser' do
      expect(@instance).to be_instance_of(AktionClient::PartnerUser)
    end
  end
