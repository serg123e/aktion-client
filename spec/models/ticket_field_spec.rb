...
# Unit tests for AktionClient::TicketField
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TicketField' do
  before do
    # run before each test
    @instance = AktionClient::TicketField.new
  end
  ...
  describe 'test an instance of TicketField' do
    it 'should create an instance of TicketField' do
      expect(@instance).to be_instance_of(AktionClient::TicketField)
    end
  end
  ...
  describe 'test attribute "html_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
