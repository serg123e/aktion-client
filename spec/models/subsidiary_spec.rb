...
# Unit tests for AktionClient::Subsidiary
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Subsidiary' do
  before do
    # run before each test
    @instance = AktionClient::Subsidiary.new
  end
  ...
  describe 'test an instance of Subsidiary' do
    it 'should create an instance of Subsidiary' do
      expect(@instance).to be_instance_of(AktionClient::Subsidiary)
    end
  end
