...
# Unit tests for AktionClient::ContactInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ContactInfo' do
  before do
    # run before each test
    @instance = AktionClient::ContactInfo.new
  end
  ...
  describe 'test an instance of ContactInfo' do
    it 'should create an instance of ContactInfo' do
      expect(@instance).to be_instance_of(AktionClient::ContactInfo)
    end
  end
  ...
  describe 'test attribute "code_locality"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["unknown", "phone", "email"])
